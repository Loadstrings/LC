...
local characteeer = asdf.Character

local xd = characteeer["InviteEgg"].Handle
...
local hat = Align(char['InviteEgg'].Handle,char['Head'],false)
local cf = char['Head'].CFrame*CFrame.new(0,0,0)*CFrame.Angles(math.rad(0),math.rad(0),0)
...
Align(game.Players.LocalPlayer.Character["AJBackAccessory"].Handle, GUN.Base, Vector3.new(1.8, 0.5, 0), Vector3.new(-0, 0, 3))
-- -gh 4623059912
